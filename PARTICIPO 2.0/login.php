...
$error_login = false; // control error 

if (isset($_POST['usuario'], $_POST['password'])) {
    $usuario = $_POST['usuario'];
    $password = $_POST['password'];

    // exitencia y credenciales correctas
    ...
    if ($result->num_rows === 1) {
        ...
        $_SESSION['idProfesor'] = $row['idProfesor']; //idProfesor en la sesión
        ...
        if ($resultProfesor->num_rows === 1) {
            ...
            $_SESSION['nombreProfesor'] = $profesor['nombre']; }
